function convert_to_unicode(ycode)
{
...
//**************************************************************************************
    ...
    var modified_substring = ycode;
    //  document.getElementById("legacy_text").value  ;

    Replace_Symbols( ) ;

    return processed_text = modified_substring ;
...
//*******************************************************************************
function convert_to_Preeti(xcode)
{
var array_one = new Array(
"‘","?",
